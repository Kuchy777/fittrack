...
class FoodProduct(
    ...
    var carbsG: BigDecimal = BigDecimal.ZERO,
...
class DiaryEntry(
    ...
    var quantityG: BigDecimal,

    @Column(nullable = false, precision = 8, scale = 2)
    var kcal: BigDecimal = BigDecimal.ZERO,
...
class Recipe(
    ...
    var prepTimeMin: Int = 0,

    @Column(nullable = false)
    var servings: Int = 1,

    @Column(name = "kcal_per_serving", precision = 7, scale = 2)
    var kcalPerServing: BigDecimal = BigDecimal.ZERO,
...
class WorkoutActivity(
    ...
    @Column(name = "kcal_burned", nullable = false)
    var kcalBurned: Int,
